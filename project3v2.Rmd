...
ggplot(data=subset(delin, delin$IncomeRange != '$0'), 
       aes(y=LoanYear, x=LoanStatus)) +
  geom_point(aes(color=LoanStatus),size=3, alpha=0.5, position='jitter') +
  facet_wrap(~IncomeRange) +ggtitle("Delinquent loan exposure summary") +
  xlab("Loan Status") + ylab("Loan Year") +
  scale_colour_brewer("Loan Status", type="seq") +
  scale_x_discrete(labels="")
...
income ranges in $25k-50k and $50-75k.
